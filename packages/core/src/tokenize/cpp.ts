...
import { CPP_KEYWORDS, CPP_OPERATORS, NORM_NUM, NORM_RAW, NORM_STR, classifyIdentifier } from './normalize.js';

const CPP_OPERATORS_SORTED = sortByLengthDescending(CPP_OPERATORS);
